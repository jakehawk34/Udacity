...
print("Array test: ", json_parse('["testing", 1, 2, 3]'))
print("Number test: ", json_parse('-123.456e+789'))
print('Object test: ', json_parse('{"age": 21, "state":"CO","occupation":"rides the rodeo"}'))
#json_parse('[["The dictionary after this array has an int, a string and another array"], {"age": 23, "state": "VA", \
