...
def strategy_d(state):
    "Hold at 20 pending. Double if (me + pending) - you >= 10. Always accept."
    (p, me, you, pending, double) = state
    if pending >= 20 or me + pending >= goal:
        return 'hold'
    else:
        if me >= goal - 20 and double == 1 and you <= 25:
            return 'double'
        return 'roll'
...
#print(pig_actions_d((0, 2, 3, 0, 1)))
#print(pig_actions_d((1, 20, 30, 5, 2)))
#print(pig_actions_d((0, 5, 5, 5, 1)))
#print(pig_actions_d((1, 10, 15, 6, 'double')))
#print(test())
